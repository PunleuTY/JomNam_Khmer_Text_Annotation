...
export function AnnotationList({
  ...
  return (
    <Card className={"w-full h-full bg-white shadow-md hover:shadow-lg transition duration-300 border-b-4 border-t-4 border-[#12284c]"}>
